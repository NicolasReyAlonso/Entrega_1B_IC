...
void setup() 
{
  ...
  if (!CH_DBG_THREADS_PROFILING) {
      SerialUSB.println("You must set CH_DBG_THREADS_PROFILING to TRUE in");
      SerialUSB.print("src/rt/templates/chconf.h ");
      while (true) {}
  } 
  if (!CH_CFG_NO_IDLE_THREAD) {
      SerialUSB.println("You must set CH_CFG_NO_IDLE_THREAD to TRUE in");
      SerialUSB.print("src/rt/templates/chconf.h ");
      while (true) {}
  } 
